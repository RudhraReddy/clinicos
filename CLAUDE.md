...
interface InvoicePrintProps {
  ...
  paid?: boolean                // prints "PAID IN FULL" between header and patient details; false on a draft preview
  date?: Date
